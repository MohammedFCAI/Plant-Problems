namespace Plant_Problems.Service.Authentications.Implementations
{
    public class UserService : IUserService
    {
        ...
        public async Task<ServiceResponse<ApplicationUser>> DeleteUser(string userId, string password)
        {
            ...
            if (!result)
                return new ServiceResponse<ApplicationUser>() { Entities = null, Success = false, Message = "Invalid password!" };
